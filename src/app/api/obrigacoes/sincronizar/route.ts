 ...
 *
 * Não espera terminar: a varredura leva ~45 minutos (medido: 1.575 empresas em
 * 46 min), tempo demais para uma requisição. A rota INICIA e
 ...
 * aqui porque o NaveX roda como servidor Node no compose, não em função efêmera.
